...
template<typename T>
MixtureInjection<T>::MixtureInjection(int id, int mixtureId, arch::Channel<T>* injectionChannel, T injectionTime) : id(id), mixtureId(mixtureId), injectionChannel(injectionChannel), injectionTime(injectionTime) {}
...
template<typename T>
arch::Channel<T>* MixtureInjection<T>::getInjectionChannel() {
