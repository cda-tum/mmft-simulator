...
class ResistanceModel {
   ...
   */
  virtual T getChannelResistance(std::shared_ptr<arch::RectangularChannel<T>> const channel) const = 0;
   ...
   */
  virtual T getDropletResistance(std::shared_ptr<arch::RectangularChannel<T>> const channel, std::shared_ptr<Droplet<T>> droplet, T volumeInsideChannel) const = 0;
};
...
class ResistanceModel1D : public ResistanceModel<T> {
  ...
  public:
     ...
     * @return The resistance of the channel itself in Pas/L.
     */
    T getChannelResistance(std::shared_ptr<arch::RectangularChannel<T>> const channel) const override;
     ...
     * @return Resistance caused by the droplet in the channel in Pas/L.
     */
    T getDropletResistance(std::shared_ptr<arch::RectangularChannel<T>> const channel, std::shared_ptr<Droplet<T>> droplet, T volumeInsideChannel) const override;
