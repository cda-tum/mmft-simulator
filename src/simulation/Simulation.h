...
template<typename T>
class lbmMixingSimulator3D;

template<typename T>
class lbmOocSimulator3D;
...
public:
    ...
    */
     ...
     * @return Pointer to the newly created simulator.
    */
    lbmMixingSimulator3D<T>* addLbmMixingSimulator3D(std::string name, std::string stlFile, std::shared_ptr<arch::Module<T>> module, std::unordered_map<int, Specie<T>*> species,
                                            std::unordered_map<int, arch::Opening<T>> openings, T charPhysLength, T charPhysVelocity, T resolution, T epsilon, T tau);
     ...
     * @return Pointer to the newly created simulator.
    */
    lbmOocSimulator3D<T>* addLbmOocSimulator3D(std::string name, std::string stlFile, int tissueId, std::string organStlFile, std::shared_ptr<arch::Module<T>> module, std::unordered_map<int, Specie<T>*> species,
                                            std::unordered_map<int, arch::Opening<T>> openings, T charPhysLength, T charPhysVelocity, T resolution, T epsilon, T tau);
