...
// template<typename T>
// MixtureDistribution<T>::MixtureDistribution(arch::RectangularChannel<T>* channel, std::unordered_map<int, Specie<T>*> species) : 
//                     channel(channel), species(species) { }



// template<typename T>
// Mixture<int>* MixtureDistribution<T>::getId() const {
//     return id;
// }
