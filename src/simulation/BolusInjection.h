...
class BolusInjection {
  private:
    ...
    arch::Pump<T>* injectionPump;  ///< Pump at which the fluid is injected.
  ...
  public:
     ...
     */
    BolusInjection(int id, int mixtureId, arch::Pump<T>* injectionPump, T injectionTime);
