...
template<typename T>
T ResistanceModel1D<T>::getChannelResistance(std::shared_ptr<const arch::RectangularChannel<T>> const channel) const {
...
template<typename T>
T ResistanceModel1D<T>::getDropletResistance(std::shared_ptr<const arch::RectangularChannel<T>> const channel, std::shared_ptr<Droplet<T>> droplet, T volumeInsideChannel) const {
    T a = computeFactorA(channel->getWidth(), channel->getHeight());
...
template<typename T>
T ResistanceModelPoiseuille<T>::getChannelResistance(std::shared_ptr<const arch::RectangularChannel<T>> const channel) const {
    T a = computeFactorA(channel->getWidth(), channel->getHeight());
...
template<typename T>
T ResistanceModelPoiseuille<T>::getDropletResistance(std::shared_ptr<const arch::RectangularChannel<T>> const channel, std::shared_ptr<Droplet<T>> droplet, T volumeInsideChannel) const {
