...
*/
template<typename T>
class lbmMixingSimulator : virtual public lbmSimulator<T> {
...
protected:
    ...
    */
    ...
    virtual void initAdConverters(T density) = 0;

    virtual void prepareAdLattice(const T omega, int speciesId) = 0;

    virtual void initConcentrationIntegralPlane() = 0;

    virtual void initAdLattice(int adKey) = 0;

    /**
     * @brief Define and prepare the coupling of the NS lattice with the AD lattices.
    */
    virtual void prepareCoupling() = 0;
    ...
    */
     ...
     * @brief 
    */
    virtual void collideAndStreamAD() = 0;

    virtual void storeAdResults(int nodeId) = 0;
...
public:
    ...
    */
    ...
    virtual T getAdOmega(int key) = 0;

    virtual std::unordered_map<int, T> getAdOmegas() = 0;
