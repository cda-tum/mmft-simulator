...
template <typename T>
CFDSimulator<T>::CFDSimulator (int id_, std::string name_, std::string stlFile_, std::shared_ptr<arch::Module<T>> cfdModule_, std::unordered_map<int, arch::Opening<T>> openings_, const ResistanceModel<T>* resistanceModel_) :
    ...
    { 
        ...
        moduleNetwork = arch::Network<T>::createNetwork(cfdModule_->getNodes());
...
template <typename T>
CFDSimulator<T>::CFDSimulator (int id_, std::string name_, std::string stlFile_, std::shared_ptr<arch::Module<T>> cfdModule_, std::unordered_map<int, arch::Opening<T>> openings_, std::shared_ptr<mmft::Scheme<T>> updateScheme_, const ResistanceModel<T>* resistanceModel_) :
