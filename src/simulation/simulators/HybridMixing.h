...
lbmMixingSimulator<T>* addLbmMixingSimulator(std::string name, std::string stlFile, std::shared_ptr<arch::Module<T>> module, std::unordered_map<int, Specie<T>*> species,
     ...
     * are defaulted.
    */
    [[maybe_unused]] std::shared_ptr<lbmMixingSimulator<T>> addLbmSimulator(std::shared_ptr<arch::CfdModule<T>> const module, std::string name="") override;
    ...
    */
    [[maybe_unused]] std::shared_ptr<lbmMixingSimulator<T>> addLbmSimulator(std::shared_ptr<arch::CfdModule<T>> const module, size_t resolution, std::string name="") override;
    ...
    */
    [[maybe_unused]] std::shared_ptr<lbmMixingSimulator<T>> addLbmSimulator(std::shared_ptr<arch::CfdModule<T>> const module, 
        size_t resolution, T epsilon, T tau, T charPhysLength, T charPhysVelocity, std::string name="") override;                        
