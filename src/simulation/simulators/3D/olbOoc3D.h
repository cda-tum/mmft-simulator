...
public:
    ...
    */
    lbmOocSimulator3D(int id, std::string name, std::string stlFile, std::shared_ptr<Tissue<T>> tissue, std::string organStlFile, std::shared_ptr<arch::Module<T>> cfdModule, 
