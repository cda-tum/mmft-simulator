...
class Fluid {
  private:
    int const id;                       ///< shared identifier of the fluid.
    std::string name = "";              ///< Name of the fluid.
    std::vector<std::shared_ptr<Fluid>> mixedFluids;    ///< List of previous fluids, if this fluid was generated by mixing.
  ...
  public:
     ...
     * @param[in] id shared identifier of the fluid.
    ...
    /**
     * @brief Retrieve the shared identifier of the fluid.
     * @return shared identifier of the fluid.
     */
    int getId() const;
     ...
     */
    void addMixedFluid(std::shared_ptr<Fluid<T>> fluid);

    /**
     * @brief Gets the list of fluids, that created the actual fluid due to mixing.
     * @return List of mixed fluids.
     */
    const std::vector<std::shared_ptr<Fluid<T>>>& getMixedFluids() const;
