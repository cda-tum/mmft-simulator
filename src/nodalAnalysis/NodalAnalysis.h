...
private:
    ...
    void readCfdSimulators(std::unordered_map<int, std::shared_ptr<sim::CFDSimulator<T>>>& cfdSimulators);
    void writeCfdSimulators(std::unordered_map<int, std::shared_ptr<sim::CFDSimulator<T>>>& cfdSimulators);
    void initGroundNodes(std::unordered_map<int, std::shared_ptr<sim::CFDSimulator<T>>>& cfdSimulators);
...
public:
     ...
     */
    bool conductNodalAnalysis(std::unordered_map<int, std::shared_ptr<sim::CFDSimulator<T>>>& cfdSimulators);
